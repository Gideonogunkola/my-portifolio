    ...
    >
      <div>
        <p class=" hidden lg:block text-center lg:text-left">
          © Copyright 2021. Designed and developed by me
        </p>
        <p class=" lg:hidden text-center lg:text-left">
          © Copyright 2021.<br />
          Designed and developed by me
        </p>
      </div>
      <div
        class="flex h-full items-center justify-self-center lg:justify-self-end mt-6 lg:mt-0 "
      >
        <div>
