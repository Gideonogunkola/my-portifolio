<template>
  <div class="w-11/12 md:w-4/5 mx-auto text-base md:text-2xl mt-24 lg:mt-24">
    <div class="pt-14 grid grid-cols-1 lg:grid-cols-3 lg:gap-14" >
        ...
        <div class=" mt-8 lg:mt-0 col-span-2 lg:h-3/4 lg:overflow-y-scroll">
